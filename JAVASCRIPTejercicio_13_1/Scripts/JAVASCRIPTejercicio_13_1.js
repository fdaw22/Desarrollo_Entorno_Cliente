...
function aplicarConfiguracion(){
    ...
    document.querySelector(":root").style.setProperty("--color-letra",valores[0]);
    document.querySelector(":root").style.setProperty("--verde-color",valores[1]);
    document.querySelector(":root").style.setProperty("--naranja-color",valores[2]);
    document.querySelector(":root").style.setProperty("--fuente-letra",valores[3]);
